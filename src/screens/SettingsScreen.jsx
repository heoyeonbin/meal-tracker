        ...
        {openSection === "project" && (
          <div style={{ padding: "12px 16px 16px" }}>
            ...
            <div style={{ display: "flex", gap: 8, marginTop: 4 }}>
              ...
              <button className="btn-press" onClick={onSaveProject} style={{ flex: 1, padding: "11px", borderRadius: 12, background: "linear-gradient(150deg,#818CF8,#6366F1)", border: "none", color: "#fff", fontSize: 13, fontWeight: 700, cursor: "pointer", fontFamily: "inherit" }}>저장</button>
            </div>
          </div>
        )}
      </div>
